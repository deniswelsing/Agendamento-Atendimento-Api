...
public class RotasProtegidasTests
{
    ...
    private static readonly Dictionary<string, string> SemPermissaoPorProjeto = new()
    {
        ...
        ["AuthController.SessaoIrma"] = "abre a sessão do app irmão pelo refresh token, como o refresh",
        ["AuthController.Convite"] = "quem foi convidado ainda não tem conta: vale o token do link",
        ["AuthController.AceitarConvite"] = "idem: é o aceite que cria a senha",
        ["AssinaturaController.ReceberWebhookPaddle"] = "chamado pelo Paddle, protegido pela assinatura HMAC",
